...
extern void otg_smart_xy(real_T absTOL, int32_T maxIter, real_T v1, real_T d1, real_T kj, real_T kT, real_T ks, real_T kd, real_T dataVeh[3], real_T safetyS, real_T safetyD, real_T kappaMax, real_T aOrthMax, int32_T m, real_T kappa, real_T b_y0, real_T phi, real_T vx0, real_T ax0, real_T w, real_T *flag1, real_T *flag2, real_T *flag3, real_T *flagAll, emxArray_real_T *x, emxArray_real_T *y, real_T T_data[], int32_T T_size[2], real_T *TOL);
