...
## Generated on : Fri Oct 23 13:29:12 2015
## MATLAB Coder version: 2.7 (R2014b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/otg_smart_xy.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/lukas/Documents/MATLAB/Umfeldmodell/trajGen/otg/trajectory_creator/johannes
ARCH                      = maci64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/otg_smart_xy.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/otg_smart_xy -I/Users/lukas/Documents/MATLAB/Umfeldmodell/trajGen/otg/trajectory_creator/Matlab/otg_smart -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=otg_smart_xy -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
OBJS = otg_smart_xy_rtwutil.o otg_smart_xy_initialize.o otg_smart_xy_terminate.o otg_smart_xy.o power.o otg_smart_pspdT.o mrdivide.o rdivide.o abs.o otg_smart_objFun.o otg_ps.o otg_pd.o linspace.o polyder.o polyval.o otg_smart_opt_step.o repmat.o otg_smart_xy_emxutil.o otg_smart_xy_emxAPI.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
...
%.o : $(START_DIR)/codegen/lib/otg_smart_xy/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/otg_smart_xy/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
