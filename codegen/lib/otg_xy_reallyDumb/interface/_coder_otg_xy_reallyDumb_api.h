...
extern void otg_xy_reallyDumb_api(const mxArray *prhs[20], const mxArray *plhs[4]);
extern void otg_xy_reallyDumb(real_T v1, real_T d1, real_T kj, real_T kT, real_T ks, real_T kd, real_T dT, real_T Tmin, real_T Tmax, emxArray_real_T *dataVeh, real_T safetyS, real_T safetyD, real_T dt, real_T m, real_T kappa, real_T b_y0, real_T phi, real_T vx0, real_T ax0, real_T w, real_T *flag, emxArray_real_T *x, emxArray_real_T *y, real_T *T);
