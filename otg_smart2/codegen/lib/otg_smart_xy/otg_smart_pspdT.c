 ...
 * Return Type  : void
 */
void otg_smart_pspdT(double absTOL, int maxIter, const double S[3], const double
                     D[4], double kj, double kT, double ks, double kd, const
                     double dataVeh[3], double safetyS, double safetyD, double
                     kappa, double kappaMax, double aOrthMax, double *flag1,
                     double *flag2, double *flag3, double *flagAll, double
                     ps_data[], int ps_size[2], double pd_data[], int pd_size[2],
                     double T_data[], int T_size[2], double *TOL)
{
  int i1;
  double Tstart;
  double Ts[3];
